...
public class BrowserstackUploadManagerTest {
    ...
    public void uploadApp() {
        ...
        AppUploadResponse upload = BrowserStackUploadManager.getInstance("demouser_05DZNj", "nvMjxDZGqohqLzveFEey")
                .upload(sample_app.getPath());
        AppUploadResponse upload1 = BrowserStackUploadManager.getInstance("demouser_05DZNj", "nvMjxDZGqohqLzveFEey")
                .upload(sample_app.getPath());
