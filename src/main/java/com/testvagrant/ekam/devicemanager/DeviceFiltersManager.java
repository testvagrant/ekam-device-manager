...
public class DeviceFiltersManager {
  ...
  public Predicate<TargetDetails> createDeviceFilters(
    ...
    Predicate<TargetDetails> basePredicate = deviceFilterPredicates.filterByPlatform(platform);
    return basePredicate
        .and(deviceFilterPredicates.filterByModel(deviceFilters.getModel()))
        .and(deviceFilterPredicates.filterByUdid(deviceFilters.getUdid()))
        .and(deviceFilterPredicates.filterByPlatformVersion(deviceFilters.getPlatformVersion()));
  }
}
